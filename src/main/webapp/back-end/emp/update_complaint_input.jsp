...
<% //見com.emp.controller.EmpServlet.java第163行存入req的complaintVO物件 (此為從資料庫取出的complaintVO, 也可以是輸入格式有錯誤時的complaintVO物件)
...
<title>申訴資料修改 - update_emp_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>申訴資料修改 - update_complaint_input.jsp</h3>
